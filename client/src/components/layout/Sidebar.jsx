...
const roleMenuLabel = { student: 'Talaba menyusi', teacher: 'O\'qituvchi menyusi', admin: 'Admin menyusi' };
    ...
    <>
      ...
      `}>
        <div className="h-16 flex items-center px-6 border-b border-gray-200 dark:border-gray-700">
          ...
          <button onClick={onClose} className="ml-auto p-1 lg:hidden hover:bg-gray-100 dark:hover:bg-gray-800 rounded">
