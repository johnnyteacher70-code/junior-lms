        ...
        <div className="p-6">
          ...
          {group.telegramLink && (
            <a
              ...
              className="flex items-center justify-between p-4 bg-blue-50 dark:bg-blue-900/20 rounded-xl mb-4 hover:bg-blue-100 dark:hover:bg-blue-900/30 transition-colors"
            >
